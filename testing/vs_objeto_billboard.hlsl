...
cbuffer cbuffer_objeto : register(b2) : CBUFFER_OBJETO
{
	...
	matrix matriz_textura : packoffset(c76) : OBJETO_MATRIZ_TEXTURA;
};
...
struct input_objeto_texturado_3d
{
...
void vs_objeto_billboard(input_objeto_texturado_3d input, out float4 ModeloPhong : ModeloPhong, out float2 BillboardTexCoord : BillboardTexCoord, out float4 ProjectedPosition : SV_POSITION)
{
    ...
    BillboardTexCoord = billboardTexCoord(input.TEXCOORD);
