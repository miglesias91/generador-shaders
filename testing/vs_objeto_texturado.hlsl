...
void vs_objeto_texturado(input_objeto_texturado input, out float4 ModeloPhong : ModeloPhong, out float2 ObjetoTexCoord : ObjetoTexCoord, out float4 ProjectedPosition : SV_POSITION)
{
