...
int null_light : ESCENA_NULL_LIGHT;
int directional_light : ESCENA_DIRECTIONAL_LIGHT;
int point_light : ESCENA_POINT_LIGHT;
int spot_light : ESCENA_SPOT_LIGHT;
int cantidad_de_luces : ESCENA_CANTIDAD_DE_LUCES_EN_ESCENA;
Luz luces[16] : ESCENA_LUCES;
...
Material material[16] : OBJETO_MATERIALES;
int material_actual : SUBOBJETO_MATERIAL_ACTUAL;
